...
function lesson_save_question_options($question, $lesson, $contextid) {
    ...
    switch ($question->qtype) {
        ...
        case LESSON_PAGE_DDMATCH: //@author Le Xuan Anh (AnhLX) Ver2 Add New
...
class qformat_default {
    ...
    var $qtypeconvert = array('numerical'   => LESSON_PAGE_NUMERICAL,
        ...
        'ddmatch'     => LESSON_PAGE_DDMATCH //@author Le Xuan Anh (AnhLX) Ver2 Add New
    );
    ...
    function importprocess($filename, $lesson, $pageid) {
        ...
        foreach ($questions as $question) {   // Process and store each question
            switch ($question->qtype) {
                ...
                case 'truefalse' :
                case 'multichoice' :
                case 'ddmatch' : //@author Le Xuan Anh (AnhLX) Ver2 Add New
                case 'match' :
                    $count++;
